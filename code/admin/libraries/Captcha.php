 ...
 * $captcha->doimage();
 * //取得验证
 * $_SESSION['code']=$captcha->get_code();
 */
class Captcha {
	//验证码的宽度
	public $width=130;
	...
	function __construct() {
		$rand = rand(0,1);
		if($rand==0) {
			$this->font = FCPATH.'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'elephant.ttf';
		} else {
			$this->font = FCPATH.'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'Vineta.ttf';
		}
	}
