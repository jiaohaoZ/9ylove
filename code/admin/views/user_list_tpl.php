...
<div class="pad_10">
    <form name="searchform" action="" method="get">
        <input type="hidden" value="user_list" name="m">
...
<script type="text/javascript">
    ...
    function edit(id, name) {
        ...
        window.top.art.dialog({
            title: '<?php echo lang('edit') . lang('user_name')?>《' + name + '》',
            id: 'edit',
            iframe: '?m=user_edit&c=user&a=edit&user_id=' + id,
            width: '500',
            height: '500'
        }, function () {
    ...
    function editAgent(id, name) {
        ...
        window.top.art.dialog({
            title: '<?php echo lang('edit') . lang('user_name')?>《' + name + '》',
            id: 'edit',
            iframe: '?m=agent_edit&c=user_agent&a=edit&user_id=' + id,
            width: '500',
            height: '500'
        }, function () {
            var d = window.top.art.dialog({id: 'edit'}).data.iframe;
    ...
    function info(id) {
        window.top.art.dialog({id: 'edit'}).close();
        window.top.art.dialog({
            title: '<?php echo lang('member_detail')?>',
            id: 'edit',
            iframe: '?m=user_info&c=user&a=init&user_id=' + id,
            width: '550',
            height: '550'
        });
    }
