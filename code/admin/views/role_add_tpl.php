...
<form name="myform" action="?c=role&m=add&a=add" method="post" id="myform">
<table width="100%" class="table_form contentWrap">
<tr>
<td><?php echo lang('role_name')?></td> 
<td><input type="text" name="info[role_name]" value="" class="input-text" id="role_name"></input></td>
</tr>
<tr>
...
<td><input type="radio" name="info[disabled]" value="0" checked> <?php echo lang('enable')?>  <label><input type="radio" name="info[disabled]" value="1"><?php echo lang('ban')?></td>
</tr>
</table>
