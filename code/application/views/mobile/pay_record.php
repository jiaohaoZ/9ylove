    ...
    <div class="record load-content">
        <ul class="record-list lists">
            ...
            <li class="item">
                ...
                <div class="right">
                    <p class="label">向代理商<?=$val['agent_name']?>充值</p>
                    <p class="num"><?=$val['pay_money']?></p>
                </div>
            </li>
            <?php }?>
            <?php }?>
    ...
    $(function () {
        ...
        var dropload = $('.load-content').dropload({
            ...
            loadDownFn: function (me) {
                ...
                $.ajax({
                    type: 'post',
                    url: "<?=site_url('pay/pay_record_load')?>",
                    data: {
                        page: num
                    },
                    dataType: 'json',
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.lists.length; i++) {
                            ...
                            result += '<div class="right"><p class="label">向代理商'+data.lists[i].agent_name+'充值</p>';
                            result += '<p class="num">'+data.lists[i].pay_money+'</p><div></li>';
                        }
